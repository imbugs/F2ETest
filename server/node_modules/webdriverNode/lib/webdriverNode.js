...
// log test result
    showTest:function (theTest, receivedValue, expectedValue, message) {
        if (theTest) {
            ...
            console.log(colors.red + "x" + colors.reset + "\t" + message + "\t" + colors.white + expectedValue + colors.reset + " !== " + colors.red + receivedValue + colors.reset);
        }
    },
    ...
    saveScreenshotToFile:function ( data, errorCode ) {
        ...
        if( process.argv.length > 1 ){
            ...
            if ( this.screenshotPath === "") {
                ...
                prePath = runner.substring( 0, runner.lastIndexOf( '/' )) + this.screenshotPath;
            }
        }
